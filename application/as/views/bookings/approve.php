...
<div id="main" style="margin:0px;">
	<div id="calendar">
		...
		<?php $msg->showMessage();?>
		<?php echo $form->start(array('class'=>'form-3','action'=>$html->addLink(array('controller'=>'bookings','action'=>'approve')))); ?>
			<fieldset>
				...
				$form->addField(array('label'=>'*Email subject:','name'=>'subject','type'=>'text','value'=>AppGlobal::$templateTypes['APPROVE'])); 
