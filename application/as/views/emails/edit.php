...
<div id="main" style="margin:0px;">
	<div id="calendar">
		...
		<?php echo $form->start(array('class'=>'form-3','action'=>$html->addLink(array('controller'=>'emails','action'=>'edit')))); ?>
			<fieldset>
				<legend>Edit</legend>
				...
				$form->addField(array('label'=>'*Name:','name'=>'name','type'=>'text','value'=>$data->name)); 
				$form->addField(array('label'=>'*Type:','name'=>'type','type'=>'select','options'=>$opt,'value'=>$data->type)); 
				$form->addField(array('label'=>'*Content:','name'=>'content','type'=>'textarea','value'=>$data->content)); 
				echo $form->show();
				?>
				<div>
